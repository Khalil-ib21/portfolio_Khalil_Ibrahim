...
export default function PortfolioPage() {
  const skillCategories: Record<string, string[]> = {
    "Site & Construction": [
      "Site Coordination & Daily Routines",
      "Subcontractor Coordination & Interface",
      "Health & Safety Compliance",
      "Quality Assurance & Documentation",
      "Toolbox Talks & Safety Walks",
      "Materials & Logistics Support",
      "Constructability Awareness",
      "Progress Reporting & Record-Keeping",
      "Audit Readiness Support",
    ],
    "Project Controls & Delivery": [
      "Programme Support & Progress Tracking",
      "Risk & Issue Log Maintenance",
      "Action & Decision Log Support",
      "Stakeholder & Client Coordination",
      "Reporting Pack Contributions",
    ...
    "Digital Engineering & BIM": [
      ...
      "Autodesk Tandem",
      "Asset Information Quality Assurance",
      "ISO 19650 Awareness",
      "Digital Twins",
      "FM-Readiness & Handover Support",
